        ...
        <div>
            <div className="tweet-box">
                <div className="d-flex">
                    <img className="profile-image mb-auto" src={`http://localhost:5000/${userInfo.picture}`} alt="profile" />
                    <TextareaAutosize className="ms-2 mt-2 text_area" name="text" value={tweet.text} onChange={handleChange} aria-label="empty textarea" placeholder="What's Happening" />
                </div>
                <div className="image-tweet">
                    ...
                    <Button className="d-block py-1 px-3 ms-auto tweet_btn" onClick={tweetAction} disabled={(!tweet || !tweet.text) ? true : false}>Tweet</Button>
                </div>
            </div>
